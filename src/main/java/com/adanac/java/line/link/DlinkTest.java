package com.adanac.java.line.link;
...
public class DlinkTest {
	...
	private static Student[] students = new Student[] { new Student(10, "sky"), new Student(20, "jody"),
			new Student(30, "vic"), new Student(40, "dan"), };
